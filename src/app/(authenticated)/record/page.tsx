        ...
        <div className="flex flex-col gap-6 select-none max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-3">
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col gap-3">
                        {[1, 2, 3, 4].map(idx => (
                            <div key={idx} className="h-20 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200/20 animate-pulse flex items-center justify-between px-5">
                                <div className="flex flex-col gap-2">
                                    <div className="w-32 h-4 bg-slate-200 dark:bg-white/10 rounded-md" />
                                    <div className="w-20 h-3 bg-slate-200 dark:bg-white/10 rounded-md" />
                                </div>
                                <div className="w-12 h-6 bg-slate-200 dark:bg-white/10 rounded-full" />
                            </div>
                        ))}
                    </div>
